...
public class SensorServiceAppMongoDBCustomDBSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SensorServiceAppMongoDBCustomDBSecurityConfig(DataSource dataSource)
    {
