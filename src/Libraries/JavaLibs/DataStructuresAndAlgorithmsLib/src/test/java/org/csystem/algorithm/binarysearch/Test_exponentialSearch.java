...
public class Test_exponentialSearch {
    private static final Comparator<String> ms_comparator = String::compareTo;
    ...
    public Test_exponentialSearch(List<String> list)
    {
    ...
    public void test_exponentialSearch()
    {
        ...
        var actualOpt = ArrayAlgorithm.exponentialSearch(m_str, s, ms_comparator);
