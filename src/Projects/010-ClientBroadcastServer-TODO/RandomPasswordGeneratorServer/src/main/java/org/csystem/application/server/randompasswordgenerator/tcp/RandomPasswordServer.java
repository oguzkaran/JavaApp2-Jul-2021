package org.csystem.application.server.randompasswordgenerator.tcp;
...
@Component
public class RandomPasswordServer {
    ...
    public RandomPasswordServer(ServerSocket serverSocket, ExecutorService threadPool, Map<Socket, ClientInfo> clients, RandomPasswordService randomPasswordService)
    {
