...
VALUES ('csd', '$2a$10$9p0Efw6X3mkn9MaWWqpz8ex34vAHj0C9oT7NoDfzD3pGKmMk8VmMa', true, false, current_timestamp, current_timestamp, null, 'SYSTEM DEFAULT ROOT USER'); --csd1993
...
VALUES (1, 'ROLE_SYSTEM_ADMIN',false, current_timestamp, current_timestamp, null, 'SYSTEM DEFAULT ROOT USER ROLE');
